...
<body style="background: url(./image/about.PNG) center/cover fixed no-repeat;">
  ...
  <div class="one">
    <h1>US:</h1>
    <h2>We are a group of individuals studying at Voorhees College vellore made this website to for sake of the students of our
      college.</h2> <br>
    <h1>MOTIVE:</h1>
    ...
    <h2>The main objective of this project is to create a website to book a shuttle for the
      students in Voorhees College as many students don’t carry cash. Through our Website, Students
