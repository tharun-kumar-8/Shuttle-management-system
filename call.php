  ...
  <div class="left">
   <form action="processcall.php" method="POST">
    ...
    <select name="source" id="" required>
     ...
     <option value="mb">CS BLOCK</option>
     <option value="gdn">ZOOLOGY BLOCK</option>
     <option value="cdmm">HISTORY BLOCK</option>
     <option value="smv">MATHS BLOCK</option>
     <option value="cbmr">CHEMISTRY BLOCK</option>
     <option value="tt">COLLEGE CAFETERIA</option>
     <option value="sjt">DEFENCE BLOCK</option>
     <option value="gb">COBB HALL</option>
